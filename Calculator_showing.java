...
public class Calculator_showing extends JFrame
{
    ...
    private JTextField Hex_textFiled;
    private JTextField DEC;
    private JTextField Oct_textFiled;
    private JTextField BIN_textFiled;
    ...
    private void Equation()
    {
        ...
        Hex_textFiled.setText(si);

        int id = Integer.parseInt(pr_textFild.getText());
        DEC.setText(String.valueOf(i));

        String sd = pr_textFild.getText();
        int iss = Integer.parseInt(s);
        String sc = Integer.toBinaryString(i);
        BIN_textFiled.setText(sc);


        String sr = pr_textFild.getText();
        int ie = Integer.parseInt(s);
        String sf = Integer.toOctalString(i);
        Oct_textFiled.setText(sf);
    ...
    public Calculator_showing() {
        ...
        Delete_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Hex_textFiled.setText("");
                Oct_textFiled.setText("");
                BIN_textFiled.setText("");
                DEC.setText("");
